...
sprite_prefetch(sprLiarDanceAtk3TetoFullsize)
...
sprite_prefetch(sprLiarDanceAtk4Trash)
...
sprite_prefetch(sprLiarDanceAtk4Car)
sprite_prefetch(sprLiarDanceAtk4CarWindow)
sprite_prefetch(sprLiarDanceAtk4BuroCat)
sprite_prefetch(sprLiarDanceAtk4BuroTank)