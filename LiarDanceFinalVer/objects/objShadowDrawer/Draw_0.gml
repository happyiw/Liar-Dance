with(objCustomBullet) {
	if drop_shadow					//draws the shadow
	    draw_sprite_ext(sprite_index,image_index,x+4,y+4,image_xscale,image_yscale,image_angle,c_black,image_alpha-0.7)
	if !draw						//draws the bullet
